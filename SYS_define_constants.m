...
%   order to bring C into the scope of the function.
    ...
    %% GUI Window Names
    % Keep h_GUI_CandlesMain as the last entry so that it's the last window
    % to be closed when exiting.
    C.GUI_WINDOWS = {'h_GUI_CandlesTxSet', ...
                     'h_GUI_CandlesRxSet', ...
                     'h_GUI_CandlesBoxSet', ...
                     'h_GUI_CandlesSimSet', ...
                     'h_GUI_CandlesIllumSim', ...
                     'h_GUI_CandlesCommSim', ...
                     'h_GUI_CandlesMain'};
